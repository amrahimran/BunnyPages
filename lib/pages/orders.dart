      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              ...
              children: [
                ...
                Text("Status: ${order['status'] ?? 'Pending'}",
                    style: TextStyle(
                        fontWeight: FontWeight.w600, color: Color(0xFF7dadc4))),
              ],
            ),
            ...
            ...items.map((item) {
                final product = item['product']; // access product object
                return Padding(
                        ...
                        ? Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              image: DecorationImage(
                                image: AssetImage('assets/${product['image']}'), // prepend assets/
                                fit: BoxFit.cover,
                              ),
                            ),
                          )
                        : Icon(Icons.book, color: Color(0xFF7dadc4), size: 26),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Padding(
        ...
        child: isLoading
            ? const Center(child: CircularProgressIndicator(color: Color(0xFF7dadc4)))
            : orders.isEmpty
                ? Center(
                    child: Text(
